...
// May sit BELOW the detected permission. Admin on client C's repo is real, but its
...
const UNIT = v => {
  ...
  // client-a tracks package-lock.json (nextly alpha.20) AND pnpm-lock.yaml (alpha.30).
...
export const FIELDS = {
  ...
  "identity.prHost":        [false, isStr],            // client-b: PRs and the checkout are different repos
