...
| 5 | "Second-project onboarding." | **OPEN, founder action.** "revnix repos need a fresh App installation… rext and a client site have no ledger, so intake there is founder-filing only." |
