...
`,
  ...
  },
  {
    ...
    edits: [{ file: ".agents/skills/resume-work/scripts/lib.mjs",
              find: "return names.length === BOARD_COLUMNS.length && BOARD_COLUMNS.every",
              replace: "return BOARD_COLUMNS.every" }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: ".agents/skills/resume-work/scripts/lib.mjs",
              find: "!visited.has(n) && c.state === \"CLOSED\"",
  ...
  },
  {
    ...
    edits: [{ file: ".agents/skills/resume-work/scripts/lib.mjs",
              find: "  return [...cards].filter(([n, c]) => !visited.has(n) && c.state === \"OPEN\").map(([n, c]) => ({ number: n, ...c }));",
              replace: "  return [...cards].filter(([n, c]) => !visited.has(n) && false).map(([n, c]) => ({ number: n, ...c }));" }],
  },
];
