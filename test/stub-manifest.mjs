...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/build/artifact.mjs",
              find: "        if (!body.includes(need)) findings.push(`${heading} has no ${need} line`);",
              replace: "        if (!text.includes(need)) findings.push(`${heading} has no ${need} line`);" }],
  },
  {
    ...
    edits: [{ file: "src/build/artifact.mjs",
              find: "      else if (typeof parsed.depth !== \"string\" || !parsed.depth.trim())",
