...
export const STUBS = [
  ...
  },
  {
    ...
    edits: [{ file: "src/doctor.mjs",
              find: "  if (dirty.ok && dirty.out) return { id, level: BROKEN, title,",
              replace: "  if (false && dirty.out) return { id, level: BROKEN, title," }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: "src/doctor.mjs",
              find: "  if (text === null) return { id, level: UNKNOWN, title,",
              replace: "  if (text === null) return { id, level: OK, title," }],
  },
  {
