...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "  for (let a; k < words.length && (a = assignment(words[k])); k++) if (a.name === \"PATH\") path = literalPath(a.value);",
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "k < words.length && (a = assignment(words[k])); k++) if (a.name === \"PATH\") path = literalPath(a.value);",
              replace: "k < words.length && (a = assignment(words[k])); k++) void a;" }],
  },
  {
    ...
    expectRed: "a literal PATH before the program is where it's looked up, and a PATH built from expansions isn't judged",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "const literalPath = (value) => (value.expansion ? null : value.text.split(\":\"));",
              replace: "const literalPath = (value) => value.text.split(\":\");" }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "  const shell = setting(\"script-shell\", fromEnv, project, user, global, builtin);",
              replace: "  const shell = setting(\"script-shell\", fromEnv);" }],
  },
  {
    ...
    expectRed: "npm's script-shell is read as npm reads it: the environment, then the project's .npmrc, a workspace root's for its workspaces, the user's, the global one",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "    if (Array.isArray(patterns) && listed(patterns, relative(p, dir))) return p;",
              replace: "    if (false) return p;" }],
  },
  {
    ...
    edits: [{ file: "src/profile/detect.mjs",
              find: "{ shell = scriptShell(npmScriptShell(dir)) }",
              replace: "{ shell = scriptShell() }" }],
  },
  {
