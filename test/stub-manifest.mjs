...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "      if (!words.length && !t.quoted && (t.text === \"{\" || ctx.shell?.keywords.has(t.text)) && t.text !== \"!\" && t.text !== \"time\") {",
              replace: "      if (false) {" },
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "  for (let a; k < words.length && (a = assignment(words[k])); k++) if (a.name === \"PATH\") path = literalPath(a.value, ctx.pkg.dir);",
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "function wrapper(name, rest, path, ctx) {\n  let i = 0, p = path;",
              replace: "function wrapper(name, rest, path, ctx) {\n  if (name) return null;\n  let i = 0, p = path;" }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "  if (name.expansion) return UNKNOWN;\n",
              replace: "" },
            { file: "src/profile/shellscript.mjs",
              find: "  if (!name || name.expansion) return name ? UNKNOWN : OK;",
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "    return [join(pkg.dir, \"node_modules\", \".bin\"), ...(process.env.PATH ?? \"\").split(delimiter)].some((d) => d && runnable(join(d, name)));",
              replace: "    return true;" }],
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "      return args.length > k ? command(args.slice(k), path, state, ctx) : OK;",
  ...
  },
  {
    ...
    expectRed: "options that still run the command, command -p, env -i and -u, exec -a, don't stop it being judged",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "      if (/^-[iv0]+$/.test(o) || o === \"--ignore-environment\") { if (o.includes(\"i\")) p = [\"/bin\", \"/usr/bin\"]; continue; }",
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "if (o.includes(\"i\")) p = [\"/bin\", \"/usr/bin\"]; ",
              replace: "" }],
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "    if (/ is a (special )?shell builtin$/.test(said)) builtins.add(word);",
              replace: "    if (said) builtins.add(word);" }],
  },
  {
  ...
  },
  {
    ...
    expectRed: "a missing program after a first command is judged when it decides the result: after &&, under set -e, at a pipeline's end",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "if (/^-[a-zA-Z]*e/.test(o) || (o === \"-o\" && text[k + 1] === \"errexit\")) state.errexit = true;",
              replace: "if (/^-[a-zA-Z]*e/.test(o) || (o === \"-o\" && text[k + 1] === \"errexit\")) void state;" }],
  },
  {
    ...
    expectRed: "a missing program after a first command is judged when it decides the result: after &&, under set -e, at a pipeline's end",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "  const r = simple(list[j].words, { ...state }, ctx);",
              replace: "  const r = simple(list[i].words, { ...state }, ctx);" }],
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "      if (!words.length && !t.quoted && (t.text === \"{\" || ctx.shell?.keywords.has(t.text)) && t.text !== \"!\" && t.text !== \"time\") {",
              replace: "      if (!words.length && (t.text === \"{\" || ctx.shell?.keywords.has(t.text)) && t.text !== \"!\" && t.text !== \"time\") {" },
            { file: "src/profile/shellscript.mjs",
              find: "  if (!name.quoted && shell?.keywords.has(name.text)) {",
  ...
  },
  {
    ...
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "k++) if (a.name === \"PATH\") path = literalPath(a.value, ctx.pkg.dir);",
              replace: "k++) void a;" }],
  },
  {
    ...
    expectRed: "a literal PATH before the program is where it's looked up, and a PATH built from expansions isn't judged",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "  if (value.expansion) return null;\n",
              replace: "" }],
  },
  {
  ...
  },
  {
    ...
    expectRed: "a word is the shell's own exactly when the shell npm runs scripts with says so",
    edits: [{ file: "src/profile/shellscript.mjs",
              find: "      if (!words.length && !t.quoted && ctx.shell?.keywords.has(t.text) && CLOSERS.has(t.text)) {",
              replace: "      if (false) {" }],
  },
];
