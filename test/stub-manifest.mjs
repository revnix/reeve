...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/pr.mjs",
              find: "  if (left) return { ok: false, why: `published as ${name}, but ${left}`, id, conclusion, name, wouldBe: real, shadow,\n                     updated: Boolean(existing), superseded, held };\n",
              replace: "" }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: "src/pr.mjs",
              find: "  if (candidates.some((r) => r.state === \"completed\" && !passes(r))) return \"failing\";",
