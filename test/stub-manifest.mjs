...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/build/report.mjs",
              find: "                              detail: report.reason, escalation: report.escalation }),",
              replace: "                              detail: report.reason, escalation: \"bt:manufactured\" })," }],
  },
  {
  ...
  },
  {
    ...
    expectRed: "and so is the outcome-to-evidence map, which the JSON freeze cannot see",
    edits: [{ file: "src/build/report.mjs",
              find: "  blocked: ({ report }) => ({ kind: \"hold\", reason: \"blocked_other\",",
              replace: "  blocked: ({ report }) => ({ kind: \"hold\", source: \"worker\", reason: \"blocked_other\"," }],
  },
];
