...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/build/artifact.mjs",
              find: "      if (!CLAIM.test(line) || /^\\s+/.test(line)) continue;",
              replace: "      if (!CLAIM.test(line) || /^\\s+/.test(line)) continue;\n      if (CITATION.test(withoutUrls(text))) { claims++; continue; }" }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: "src/build/artifact.mjs",
              find: "      const cites = (withoutUrls(line).match(new RegExp(CITATION.source, \"g\")) ?? []).length;",
