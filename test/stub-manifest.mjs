...
`,
  ...
  },
  {
    ...
    edits: [{ file: "src/build/providerdb.mjs",
              find: "  if (!Object.hasOwn(MEASUREMENT_KINDS, kind))\n    throw new Error(`recordMeasurement:",
              replace: "  if (MEASUREMENT_KINDS[kind] === undefined)\n    throw new Error(`recordMeasurement:" }],
  },
  {
    ...
    test: "test/provider-measurement.test.mjs",
    expectRed: "a future timestamp is refused: it would be permanently recent",
    edits: [{ file: "src/build/providerdb.mjs",
