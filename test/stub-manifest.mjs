...
`,
  ...
  },
  {
    ...
    edits: [{ file: ".agents/skills/resume-work/scripts/lib.mjs",
              find: "  if (closers.length) return closers.some((pr) => triagePullRequest(pr, null).reasons.length) ? \"In progress\" : \"In review\";\n",
  ...
  },
  {
    ...
    edits: [{ file: ".agents/skills/resume-work/scripts/lib.mjs",
              find: "closers.some((pr) =>",
              replace: "closers.every((pr) =>" }],
  },
  {
  ...
  },
  {
    ...
    edits: [{ file: ".agents/skills/resume-work/scripts/lib.mjs",
              find: "  return { ...pr, closingIssuesReferences: closing.conn, commits, partial: !(closing.complete && contexts.complete) };",
              replace: "  return { ...pr, closingIssuesReferences: closing.conn, commits, partial: false };" }],
  },
  {
